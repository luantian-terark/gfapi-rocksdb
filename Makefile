...
CXXFLAGS = -Wall -g -DUSE_GLUSTER -DROCKSDB_PLATFORM_POSIX  -DOS_LINUX -std=c++11  -I$(ROCKSDB_SRC) -I$(ROCKSDB_SRC)/include -I./src
...
%.o: src/%.cc src/env_gluster.h Makefile
	$(CC) $(CXXFLAGS) -c $< -o $@

shared_lib:env_gluster.o
	$(CC) $(CXXFLAGS) -o env-gluster.so -fPIC -shared src/env_gluster.cc -lgfapi -fvisibility=hidden
